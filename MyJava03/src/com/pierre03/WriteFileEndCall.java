	...
	public void onEndCall(CallEndAPI data) throws AudiumException {
		...
		try {
			...
			if (lastExcCode != null) {
				...
				logstring.append(",lastExc.code=" + data.getSessionData("lastException.code"));
				logstring.append(",lastExc.type=" + data.getSessionData("lastException.type"));
				logstring.append(",lastExc.msg=" + data.getSessionData("lastException.message"));
				logstring.append(",lastExc.source=" + data.getSessionData("lastException.source"));
